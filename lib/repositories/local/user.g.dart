...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r"roles": PropertySchema(
      ...
      enumMap: _UserrolesEnumValueMap,
    ),
...
int _userEstimateSize(
  ...
  bytesCount += 3 + object.roles.length;
...
void _userSerialize(
  ...
  writer.writeByteList(offsets[1], object.roles.map((e) => e.index).toList());
...
User _userDeserialize(
  ...
  final object = User(
    ...
    version: reader.readLong(offsets[3]),
  );
  return object;
}
...
const _UserrolesValueEnumMap = {
  ...
  3: UserRole.contributor,
  4: UserRole.powerUploader,
  5: UserRole.forumModerator,
  6: UserRole.globalModerator,
  7: UserRole.administrator,
};
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, List<UserRole>, QQueryOperations> rolesProperty() {
    return QueryBuilder.apply(this, (query) {
